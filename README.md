# `IPFS2.ETH`
[![test](https://github.com/namesys-eth/ipfs2-eth-resolver/actions/workflows/test.yml/badge.svg)](https://github.com/namesys-eth/ipfs2-eth-resolver/actions/workflows/test.yml)
